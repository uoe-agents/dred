...
class MultiGridEmpty(ClutteredMultiGrid):

  def __init__(self):
    seed = np.random.randint(0, 100000)
    super().__init__(n_agents=1, size=15, n_clutter=0, randomize_goal=True,
                     agent_view_size=5, max_steps=250, seed=seed)
...
register.register(
    env_id='MultiGrid-Empty-v0',
    entry_point=module_path + ':MultiGridEmpty'
)
